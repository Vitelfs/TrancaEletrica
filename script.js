...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById("openButton").addEventListener("click", () => controlLock("open"));
  document.getElementById("closeButton").addEventListener("click", () => controlLock("close"));
  document.getElementById("logoutButton").addEventListener("click", logout);
  document.getElementById("flexCheckDefault").addEventListener("click", showPass);
  document.getElementById("flexCheckDefaultCadastro").addEventListener("click", showPassCadastro);
